...
export interface ApiLeagueLeague extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Golf leagues at Post 42 Golf';
    displayName: 'League';
    pluralName: 'leagues';
    singularName: 'league';
  };
  ...
  attributes: {
    ...
    format: Schema.Attribute.Enumeration<
      ['scramble', 'best_ball', 'stroke_play', 'match_play', 'coed', 'other']
    > &
      Schema.Attribute.Required;
    formatDescription: Schema.Attribute.String;
    ...
    seasonFee: Schema.Attribute.Decimal;
...
export interface ApiTournamentTournament extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Golf tournaments at Post 42 Golf';
